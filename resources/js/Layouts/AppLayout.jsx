    ...
    <>
        ...
        <div>
            ...
            <div className='hidden p-2.5 lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col'>
                <div className='flex grow flex-col gap-y-5 overflow-y-auto border rounded-xl bg-gradient-to-b from-blue-500 via-blue-600 to-blue-700 px-4'>
                    <Sidebar url={url} />
                </div>
            </div>
            ...
            <div className='sticky top-0 z-40 flex items-center p-4 bg-white shadow-sm gap-x-6 sm:px-6 lg:hidden'>
                <button
                    type='button'
                    className='-m-2.5 lg:hidden p-2.5 text-gray-700'
