...
export default function Index(props) {
    ...
    UseFilter({
        route: route('operator.schedules.index'),
        values: params,
        only: ['schedules'],
    });
        ...
        <div className="flex w-full flex-col pb-32">
            <div className="mb-8 flex flex-col items-start justify-between gap-y-4 lg:flex-row lg:items-center">
                ...
                <Button variant="orange" size="xl" className="w-full lg:w-auto" asChild>
                    <Link href={route('operator.schedules.create')}>
                            ...
                            <TableBody>
                                {schedules.map((schedule, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>{schedule.classRoom?.name ?? 'Belum ada kelas'}</TableCell>
                                        <TableCell>{schedule.start_time ?? 'Belum ada waktu mulai'}</TableCell>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-x-1">
                                                <Button variant="blue" size="sm">
                                                    <Link href={route('operator.schedules.edit', [schedule])}>
                                                ...
                                                <AlertAction
                                                    ...
                                                    action={() =>
                                                        deleteAction(route('operator.schedules.destroy', [schedule]))
                                                    }
                                                />
                                            </div>
                                        </TableCell>
